...
class TicketPanelView(discord.ui.View):
    ...
    @discord.ui.select(
        ...
        options=[
            discord.SelectOption(label='Click me', value='clickme', description='Reset the ticket category menu', emoji='🔄'),
    ...
    async def on_category_select(self, interaction: discord.Interaction, select: discord.ui.Select):
        ...
        # This is a reset/placeholder option only. Re-rendering the persistent
        # view clears the previously selected category so the same category can
        # be chosen again from the panel.
        if category == 'clickme':
